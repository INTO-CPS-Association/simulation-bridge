...
class PerformanceMetrics:
    ...
    python_start_time: float
    python_startup_duration: float
    simulation_duration: float
    python_stop_time: float
...
class PerformanceMonitor:
    ...
    def start_operation(self, operation_id: str):
        ...
        self.current_metrics = PerformanceMetrics(
            ...
            python_start_time=0.0,
            python_startup_duration=0.0,
            simulation_duration=0.0,
            python_stop_time=0.0,
    ...
    def record_python_start(self):
        ...
        self.current_metrics.python_start_time = time.time()
    ...
    def record_simulation_complete(self):
        ...
        self.current_metrics.simulation_duration = (
            time.time() - self.current_metrics.python_start_time -
            self.current_metrics.python_startup_duration
        )
        self._update_system_metrics()
    ...
    def record_python_stop(self):
        ...
        self.current_metrics.python_stop_time = time.time()
        self._update_system_metrics()
    ...
    def _save_metrics_to_csv(self, metrics: PerformanceMetrics):
        ...
        with open(self.csv_path, 'a', newline='', encoding='utf-8') as f:
            ...
            writer.writerow([
                ...
                metrics.python_start_time,
                metrics.python_startup_duration,
                metrics.simulation_duration,
                metrics.python_stop_time,
    ...
    def get_summary(self) -> Dict[str, float]:
        ...
        startup_times = [
            m.python_startup_duration for m in self.metrics_history]
