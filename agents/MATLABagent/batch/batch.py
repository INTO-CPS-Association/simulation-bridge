...
class MatlabSimulator:
    ...
    def get_metadata(self) -> Dict[str, Any]:
        ...
        if self.eng:
            try:
                matlab_version = self.eng.eval("version", nargout=1)
...
def handle_batch_simulation(parsed_data: dict, source, rabbitmq_manager: RabbitMQManager) -> None:
    """
    ...
    try:
        ...
        send_progress = progress_template.get('include_percentage', False)
