...
class IntegrationTest(unittest.TestCase):
    """Integration test class for MessageHandler and SimpleUsageSimul8Agent."""
    ...
    def test_message_handler_initialization(self, mock_connection):
        ...
        handler = MockMessageHandler(
            agent_id="test_simul8",
            rabbitmq_manager=self.mock_rabbitmq_manager,
            config=config
        )

        # Verify initialization
        self.assertEqual(handler.get_agent_id(), "test_simul8")
    ...
    def test_error_handling_invalid_yaml(self, mock_connection):
        ...
        mock_method = Mock()
        mock_method.routing_key = 'dt.simul8'
