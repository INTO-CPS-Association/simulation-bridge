...
class TestMainFunction:
    ...
    def mock_dependencies(self, mock_agent):
        ...
        with patch('src.main.Simul8Agent') as mock_simul8_agent, \
            ...
            mock_simul8_agent.return_value = mock_agent
            yield mock_simul8_agent, mock_setup_logger, mock_load_config, mock_logger
    ...
    def test_main_with_config_file(self, cli_runner, mock_dependencies):
        ...
        mock_simul8_agent.assert_called_once_with(
            'custom_agent',
            broker_type='rabbitmq',
            config_path=str(config_path)
        )
        mock_agent = mock_simul8_agent.return_value
    ...
    def test_main_without_config_file_missing(self, cli_runner):
        ...
        with patch('pathlib.Path.exists', return_value=False):
            ...
            assert "simul8-agent --generate-config" in result.output
            assert result.exit_code == 0
    ...
    def test_cli_help_option(self, cli_runner):
        ...
        assert "An agent service to manage Simul8 simulations." in result.output
        assert result.exit_code == 0
