    ...
    return {
        ...
        "response_templates": {
            "success": {
                ...
                "metadata_fields": ["execution_time", "memory_usage", "simul8_version"]
            },
            "error": {
                "status": "error",
...
def test_config_manager_initialization():
    ...
    with mock.patch("src.utils.config_manager.load_config") as load_config_mock, \
        ...
        assert manager.config["agent"]["agent_id"] == "simul8"
...
def test_get_default_config():
    ...
    assert default_config["agent"]["agent_id"] == "simul8"
...
def test_get_config():
    ...
    with mock.patch("src.utils.config_manager.load_config") as load_config_mock, \
        ...
        assert config["agent"]["agent_id"] == "simul8"
...
def test_validate_config_success():
    ...
    with mock.patch("src.utils.config_manager.load_config") as load_config_mock, \
        ...
        assert validated_config["agent"]["agent_id"] == "simul8"
