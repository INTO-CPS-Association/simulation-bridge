"""
Simul8Agent implementation - An implementation of the Simul8Agent class using the Connect
...
class Simul8Agent:
    """
    An agent that interfaces with a Simul8 simulation through a communication layer.
    ...
    def __init__(
        ...
        logger.info("Initializing Simul8 agent with ID: %s", self.agent_id)
        ...
        logger.debug("Simul8 agent initialized successfully")
    ...
    def start(self) -> None:
        ...
        """
        try:
            logger.info("Simul8 agent running and listening for requests")
            self.comm.start_consuming()
        except KeyboardInterrupt:
            logger.info("Stopping Simul8 agent due to keyboard interrupt")
            self.stop()
    ...
    def stop(self) -> None:
        ...
        """
        logger.info("Stopping Simul8 agent")
        self.comm.close()
