"""
Performance analysis module for SIMUL8 simulation bridge.

This module analyzes performance metrics collected during SIMUL8 simulations,
...
def plot_agent_overhead(df, mean_overhead):
    ...
    note_agent = (
        "Note:\n"
        "Agent Overhead is the time spent excluding Simul8 startup and simulation durations.\n"
...
def plot_startup_ratio(mean_startup_ratio):
    ...
    explanation_text = (
        ...
        "starting SIMUL8 relative to total processing time\n"
...
def generate_markdown_report(dataframe, mean_agent_overhead, mean_startup_ratio):
    ...
    lines.append(
        ...
        "SIMUL8 startup and simulation durations. "
    ...
    lines.append(
        "This ratio represents the proportion of time spent starting SIMUL8 "
