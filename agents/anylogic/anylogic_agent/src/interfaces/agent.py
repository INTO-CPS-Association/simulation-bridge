"""
This module defines the `IAnylogicAgent` interface.
"""
from abc import ABC, abstractmethod
from typing import Any, Dict


class IAnylogicAgent(ABC):
    """
    Interface for ANYLOGIC Agent that handles message reception, processing,
    and result distribution via RabbitMQ.
    """
    @abstractmethod
    def __init__(self, agent_id: str, config_path: str = None) -> None:
        """
        Initialize the ANYLOGIC Agent with the specified ID, and optionally a configuration file.
