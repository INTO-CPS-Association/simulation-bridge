"""
Performance analysis module for AnyLogic simulation bridge.

This module analyzes performance metrics collected during AnyLogic simulations,
...
def plot_agent_overhead(df, mean_overhead):
    ...
    note_agent = (
        "Note:\n"
        "Agent Overhead is the time spent excluding AnyLogic startup and simulation durations.\n"
...
def plot_startup_ratio(mean_startup_ratio):
    ...
    explanation_text = (
        ...
        "starting AnyLogic relative to total processing time\n"
...
def main():
    ...
    df["Agent Overhead (s)"] = (
        df["Total Duration (s)"]
        - df["AnyLogic Startup Duration (s)"]
...
def generate_markdown_report(dataframe, mean_agent_overhead, mean_startup_ratio):
    ...
    lines.append(
        ...
        "AnyLogic startup and simulation durations. "
    ...
    lines.append(
        "This ratio represents the proportion of time spent starting AnyLogic "
