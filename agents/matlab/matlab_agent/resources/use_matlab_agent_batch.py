...
RabbitMQ client to send batch simulation requests to a MATLAB agent
...
class BatchUsageMatlabAgent:
    ...
    def send_request(self, payload_data: Dict[str, Any]) -> None:
        ...
        print(f"[{self.agent_id.upper()}] Request sent → MATLAB "
