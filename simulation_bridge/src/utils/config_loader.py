...
def load_protocol_config(
        config_path: Optional[Union[str, Path]] = None) -> Dict[str, list]:
    """Load the protocol configuration based on in-memory mode configuration"""
